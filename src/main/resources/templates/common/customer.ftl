...
<head>
    ...
    <style>
        ...
        .right-con li .btn button.minus strong{background:url(/images/down.png) no-repeat;background-size:22px 22px;}
        ...
        .right-con li .btn button.add strong{background:url(/images/up.png) no-repeat;background-size:22px 22px;}
...
<div class="main">
    ...
    <div class="left-menu">
        <ul>
            <li class="active">${foodType.name}<span class="num-price"></span></li>
        </ul>
    </div>
    ...
    <div class="con">
        <div class="right-con con-active">
            <#list foodType.getFoodList() as food>
                <ul>
                    <li>
                    <div class="menu-img"><img src="img/pic.png" width="55" height="55" /></div>
                    <div class="menu-txt">
                        <h4>${food.name}</h4>
                        <p class="list1">${foodType.name}</p>
                        <p class="list2">
                            <b>${food.price}</b>
                        <div class="btn">
                            <button class="minus">
